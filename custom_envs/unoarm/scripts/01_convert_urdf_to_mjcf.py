...
import shutil
import sys
import xml.etree.ElementTree as ET  # nosec B405 - parses trusted local robot assets only
...
def add_cameras(xml_path: Path) -> None:
    tree = ET.parse(xml_path)  # nosec B314 - local MJCF generated by this tool
    root = tree.getroot()
